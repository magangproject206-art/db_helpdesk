...
<head>
    ...
    <style>
        ...
        .sidebar .brand-section { padding: 25px 20px; text-align: center; border-bottom: 1px solid rgba(255,255,255,0.1); }
...
<div class="sidebar shadow">
    <div class="brand-section">
        <h4 class="mb-0 font-weight-bold">CV. ROYALMA</h4>
        <small class="text-muted" style="letter-spacing: 2px;">E-HELPDESK</small>
    </div>
